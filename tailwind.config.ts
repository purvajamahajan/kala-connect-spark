...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        'cultural': ['Crimson Text', 'Noto Sans Devanagari', 'serif'],
      ...
      animation: {
        ...
        "cultural-fade": "cultural-fade 0.8s ease-out",
        "heritage-glow": "heritage-glow 2s ease-in-out infinite alternate",
        "festival-pulse": "festival-pulse 1.5s cubic-bezier(0.4, 0, 0.6, 1) infinite",
